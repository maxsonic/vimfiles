...
" Run django tests
au FileType python nmap <leader>dt :set makeprg=python\ manage.py\ test\|:call MakeGreen()<CR>
...
au FileType python nmap <leader>j :RopeGotoDefinition<CR>

" Rename whatever the cursor is on (including references to it)
au FileType python nmap <leader>r :RopeRename<CR>
" ==========================================================
